...
List<DALC.Staff> oList_DBEntries = _AppContext.Get_Staff_By_Where(i_Params_Get_Staff_By_Where.STAFF_NAME,i_Params_Get_Staff_By_Where.STAFF_PH_NB,i_Params_Get_Staff_By_Where.STAFF_MAIL,i_Params_Get_Staff_By_Where.OWNER_ID,i_Params_Get_Staff_By_Where.START_ROW,i_Params_Get_Staff_By_Where.END_ROW,ref tmp_TOTAL_COUNT);
if (oList_DBEntries != null)
{
foreach (var oDBEntry in oList_DBEntries)
{
...
List<DALC.Package> oList_DBEntries = _AppContext.Get_Package_By_Where_InList_V2(i_Params_Get_Package_By_Where_InList_V2.PACKAGE_NAME,i_Params_Get_Package_By_Where_InList_V2.PACKAGE_STARTING_DATE,i_Params_Get_Package_By_Where_InList_V2.CURRENCY_ID_LIST,i_Params_Get_Package_By_Where_InList_V2.OWNER_ID,i_Params_Get_Package_By_Where_InList_V2.START_ROW,i_Params_Get_Package_By_Where_InList_V2.END_ROW,ref tmp_TOTAL_COUNT);
if (oList_DBEntries != null)
{
foreach (var oDBEntry in oList_DBEntries)
{
...
List<DALC.Staff> oList_DBEntries = _AppContext.Get_Staff_By_Criteria_InList(i_Params_Get_Staff_By_Criteria_InList.STAFF_NAME,i_Params_Get_Staff_By_Criteria_InList.STAFF_PH_NB,i_Params_Get_Staff_By_Criteria_InList.STAFF_MAIL,i_Params_Get_Staff_By_Criteria_InList.BLOODTYPE_ID_LIST,i_Params_Get_Staff_By_Criteria_InList.OWNER_ID,i_Params_Get_Staff_By_Criteria_InList.START_ROW,i_Params_Get_Staff_By_Criteria_InList.END_ROW,ref tmp_TOTAL_COUNT);
if (oList_DBEntries != null)
{
foreach (var oDBEntry in oList_DBEntries)
{
...
List<DALC.Staff> oList_DBEntries = _AppContext.Get_Staff_By_Criteria_InList_V2(i_Params_Get_Staff_By_Criteria_InList_V2.STAFF_NAME,i_Params_Get_Staff_By_Criteria_InList_V2.STAFF_PH_NB,i_Params_Get_Staff_By_Criteria_InList_V2.STAFF_MAIL,i_Params_Get_Staff_By_Criteria_InList_V2.STAFF_DOB,i_Params_Get_Staff_By_Criteria_InList_V2.BLOODTYPE_ID_LIST,i_Params_Get_Staff_By_Criteria_InList_V2.OWNER_ID,i_Params_Get_Staff_By_Criteria_InList_V2.START_ROW,i_Params_Get_Staff_By_Criteria_InList_V2.END_ROW,ref tmp_TOTAL_COUNT);
if (oList_DBEntries != null)
{
foreach (var oDBEntry in oList_DBEntries)
{
